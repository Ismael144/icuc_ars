            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Create Notification</h4>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="">
                                <div class="col-xxl-4">
                                    <h5 class="card-title mb-3">Create Notification</h5>
                                ...
                                <div class="col-xxl-12">
                                    <form action="" method="POST">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" value="<?= handleNull("title", $notificationsPostForm) ?>" id="" class="form-control" placeholder="Enter Notification's Name...">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="body" id="body" placeholder="Enter Notification's Body..." rows="4" cols="5"><?= handleNull("body", $notificationsPostForm) ?></textarea>
                                            <span class="text-danger">
