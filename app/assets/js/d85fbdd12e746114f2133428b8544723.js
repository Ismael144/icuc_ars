    ...
    if (navigator.onLine) {
        document.getElementById("internet-status").innerHTML = `
            <div class='d-flex align-items-center justify-content-center'>
                <span class='bg-success px-1 text-white' style='border-radius: 50%;'><i class='fas fa-check'></i></span>
                <span></span>
            </div>
        `
    } else {
        document.getElementById("internet-status").innerHTML = 'Offline'
    }
}

setInterval(checkNetworkConnectivity(), 300)
