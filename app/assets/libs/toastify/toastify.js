...
(function (root, factory) {
  ...
  Toastify.lib = Toastify.prototype = {
    ...
    init: function (options) {
      ...
      this.options.title = options.title || Toastify.defaults.title; // Display message
      this.options.description =
        options.description || Toastify.defaults.description;
      ...
      this.options.icon = options.icon || Toastify.defaults.icon; // img element src - url or a path
    ...
    buildToast: function () {
      ...
      if (
        ...
        var titleAndDescriptionDivElement = document.createElement("div");
        titleAndDescriptionDivElement.classList.add("title-and-description");
        var headingElement = document.createElement("p");
        headingElement.style.color = "#101020";
        headingElement.style.color = "#101020";
        headingElement.className = "toastify-heading";
        headingElement.innerHTML = this.options.title;
        titleAndDescriptionDivElement.appendChild(headingElement);

        /* Toastify Line Loader */
        // var toastifyLoaderElement = document.createElement("div")
        // toastifyLoaderElement.classList.add("toastify-loader")
        // divElement.appendChild(toastifyLoaderElement)
        // toastifyLoaderElement.style.transition = `all 4s cubic-bezier(0.215, 0.61, 0.355, 1)`
        // toastifyLoaderElement.style.width = "50%"

        if (this.options.description != "") {
          var descriptionElement = document.createElement("p");
          descriptionElement.classList.add("description");
          descriptionElement.style.fontSize = "14px";
          descriptionElement.innerHTML = this.options.description;
          titleAndDescriptionDivElement.appendChild(descriptionElement);
        }

        divElement.appendChild(titleAndDescriptionDivElement);
        ...
        if (this.options.icon !== "") {
          ...
          if (
            ...
            divElement.insertAdjacentElement("afterbegin", iconElement);
          }
        }
      }
