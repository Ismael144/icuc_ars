...
!(function (t) {
  ...
  return (
    x.extend(!0, i.defaults, {
      dom: "<'d-flex align-items-center justify-content-between'<'entries-selector'l><'search-bar'f>><'row dt-row'<'col-sm-12'tr>><'d-flex align-items-center justify-content-between'<'entries-note'i><'paginator'p>>",
      renderer: "bootstrap",
    }),
